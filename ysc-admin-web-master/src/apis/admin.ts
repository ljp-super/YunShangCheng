 ...
 * 修改密码
 */
export function updateAdminPasswordAPI(data: { username: string; newPassword: string }) {
  return http({
 ...
 * 更新当前登录用户信息
 */
export function adminUpdateInfoAPI(data: { email?: string; nickName?: string; note?: string }) {
  return http({
