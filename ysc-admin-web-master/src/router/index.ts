...
export const asyncRouterMap: RouteRecordExt[] = [
    ...
    children: [
      {
        ...
        meta: { title: '商城中心', icon: 'product-list' },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '购物车', icon: 'shopping-cart' },
      },
    ],
  },
  {
  ...
  {
    path: '/user/ai-service',
    component: Layout,
    children: [
      {
        path: '',
        name: 'aiService',
        component: () => import('@/views/user/ai-service/index.vue'),
        meta: { title: 'AI客服', icon: 'chat' },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '知识库管理', icon: 'document-text' },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '操作日志', icon: 'order-setting' },
      },
    ],
  },
]
